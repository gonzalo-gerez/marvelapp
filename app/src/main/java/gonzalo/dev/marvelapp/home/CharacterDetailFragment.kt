...
class CharacterDetailFragment : Fragment() {
    ...
    private var detail: Character? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        arguments?.let {
            detail = it.getSerializable(EXTRA) as Character
        }
    }
    ...
    private fun updateUi(currentCharacter: Character?) {
    ...
    companion object {
        ...
        fun newInstance(post: Character? = null) = CharacterDetailFragment().apply {
            post?.let {
